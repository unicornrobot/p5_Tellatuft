...
//const float dataSmoothingFactor = 1.0;       
//const float baselineSmoothingFactor = 1.0;
...
void loop()
{
  ...
  //Serial.println( String(smoothed - baseline) + "," + String(raw - baseline + 20) + "," + String(p3 - baseline + 10) );  // get value using T0 (io4)
  
  //  Serial.println( String(raw) + "," + String(baseline));// + "," + String(p3 - baseline + 10) );  // raw and baseline
  //    Serial.println( String(map(smoothed,10,50,0,360)));
  
int touch1 = smoothed - baseline;
Serial.println(String(map(touch1,0,-45,0,360)));
